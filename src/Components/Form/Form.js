...
class Shipping extends Component {
    ...
    handleSubmit = (values, { setSubmitting }) => {
        console.log('Contact data: ', values,
            'Checkout: ', this.props.products,
            'Total price: ', this.summarizeAllPrices(this.props.products));
        setTimeout(() => {
            setSubmitting(false);
                ...
                <Formik
                    ...
                    {({ errors, touched, isSubmitting, isValid }) => (
                        <Form>
                            ...
                            <Field className={[styles.btn, styles.active].join(' ')} name="submit" disabled={!isValid || isSubmitting} value="PAY" type="submit" />
                        </Form>
                    )}
                </Formik>
            </div>
